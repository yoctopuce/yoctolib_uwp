/*********************************************************************
 *
 *  $Id: YAudioOut.cs 37619 2019-10-11 11:52:42Z mvuilleu $
 *
...
//--- (YAudioOut definitions)
    ...
    public new delegate Task ValueCallback(YAudioOut func, string value);
    public new delegate Task TimedReportCallback(YAudioOut func, YMeasure measure);
...
#pragma warning disable 1998
    ...
    public override async Task<int> _invokeValueCallback(string value)
    {
        if (_valueCallbackAudioOut != null) {
            await _valueCallbackAudioOut(this, value);
        } else {
    ...
    public static YAudioOut FirstAudioOut()
    {
        ...
        string next_hwid = yctx._yHash.imm_getFirstHardwareId("AudioOut");
        if (next_hwid == null)  return null;
