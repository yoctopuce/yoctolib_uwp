/*********************************************************************
 *
 * $Id: YSerialPort.cs 49904 2022-05-25 14:18:55Z mvuilleu $
 *
...
#pragma warning disable 1998
     ...
     * </para>
     */
    public virtual async Task<int> sendBreak(int duration)
    {
        return await this.sendCommand("B"+Convert.ToString(duration));
    }
